...
export class LoanProduct extends Component {
    constructor(props){
        super(props)
        this.state = {
          lead:"",
  ...
  render() {
    ...
    />
      ...
      <span style={{fontSize:20,fontWeight:700,display:"flex",justifyContent:"flex-start",marginLeft:25}}>Manage Loan Products</span>
  <button onClick={()=>this.openModal()} style={{backgroundColor:"#273896" , border: "none", borderRadius: 10, width: 250, height: 50, fontSize: 17, fontWeight: 600,display:"flex",alignItems:"center",justifyContent:"space-evenly",marginLeft:120}}>
      <img src={ logo3} />
       <span style={{color:"white"}}> Add Loan products</span>
       </button>
   </div>
...
<tr>
<td style={{fontWeight:600}}> Homeloan</td>
        <td> <FormControlLabel control={<IOSSwitch sx={{ m: 1 }} defaultChecked />}/><img src={logo5} />  <img src={logo6} /></td>
</tr>
<tr>
<td style={{fontWeight:600}}> Loan Against Property</td>
        <td> <FormControlLabel control={<IOSSwitch sx={{ m: 1 }} defaultChecked />}/><img src={logo5} />  <img src={logo6} /></td>
</tr>
<tr>
<td style={{fontWeight:600}}> Business Installment Loan</td>
        <td> <FormControlLabel control={<IOSSwitch sx={{ m: 1 }} defaultChecked />}/><img src={logo5} />  <img src={logo6} /></td>
</tr>
<tr>
...
<h1 style={{fontSize:25,fontWeight:740,paddingLeft:30,marginTop:35}}>Add Loan Product </h1>

<div style={{display:"flex",marginLeft:35,marginTop:10}}>
<input type="text"  placeholder="Type Name" style={{width:480,height:50,outline:"none",borderRadius:5,border:"1px solid gray"}} />
</div>
